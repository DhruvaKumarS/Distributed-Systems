                ...
                while(true){
                    ...
                    if((msg = reader.readLine()) != null){
                        ...
                        if(CLIENT_PORTS.contains(clientPort)) {
                            ...
                            Log.i("Queue", "End of queue");
                            /*msgItr = clientMessages.iterator();
                            while(msgItr.hasNext()){
                                clientMsg = msgItr.next();
                        ...
                        //Log.i("While loop", "Running now");
                        /*Iterator<ClientMessages> itr = clientMessages.iterator();
                        ClientMessages test = null;
                        while(itr.hasNext()) {
                            test = itr.next();
                            Log.i("Queue", "Head: " + test.message + " Client: " + test.clientPort
                                    + " Seq: " + test.seqNum + " deliverable: " + test.deliverable);
                        }
                        Log.i("Queue", "End of queue");*/
                        ClientMessages head = null;
