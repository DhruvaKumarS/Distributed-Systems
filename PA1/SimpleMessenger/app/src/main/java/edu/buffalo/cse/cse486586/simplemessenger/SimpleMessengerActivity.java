        ...
        editText.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                    ...
                    Log.i(TAG, "Client "+myPort+" created\n");
                    return true;
                }
                return false;
            }
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                while(true) {
                    ...
                    BufferedReader msgGet = new BufferedReader(new InputStreamReader(client.getInputStream()));
                    PrintWriter ackSend = new PrintWriter(client.getOutputStream(), true);
                    //System.out.println(client.isConnected());
                    String msg = null;
                    if ((msg = msgGet.readLine()) != null) {
                        Log.i(TAG, "Received : " + msg);
                        ackSend.println(ACKNOWLEDGE_MESSAGE);
                        Log.i(TAG, "Sent ACK : " + ACKNOWLEDGE_MESSAGE);
                        publishProgress(msg);
                    }
                }
            } catch (IOException e) {
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                 ...
                 */
                PrintWriter msgSend = new PrintWriter(socket.getOutputStream(), true);
                BufferedReader ackGet = new BufferedReader(new InputStreamReader(socket.getInputStream()));
                msgSend.println(msgToSend);
                Log.i(TAG, "To client "+remotePort+" : "+msgToSend);
                //String ack = ;
                //Log.i(TAG, ack);
